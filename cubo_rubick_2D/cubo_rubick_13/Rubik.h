...
// Definición de la estructura Rubik
class Rubik{
public:
    vector<Cubo> cubos;
    float animation_vel=0.9;
    float reg_grados=0,cant_fps;


	// Vectores que almacenan los cubos de diferentes caras
    vector<Cubo*> U;
    vector<Cubo*> F;
    vector<Cubo*> B;
    vector<Cubo*> L;
	...
	// Constructor de la estructura Rubik
    Rubik(){
		// Reserva espacio para los vectores de cubos de diferentes caras
        U.reserve(9);
        F.reserve(9);
        B.reserve(9);
        L.reserve(9);
		...
		// Reserva espacio para el vector de todos los cubos
