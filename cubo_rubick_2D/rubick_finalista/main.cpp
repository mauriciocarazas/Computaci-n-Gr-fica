...
-Con las teclas direccionales la camara se mueve arriba, abajo, izquierda, derecha.
-Con las tecla U se mueve la camada de arriba		(UP)
-Con las tecla D se mueve la camada de abajo		(DOWN)
-Con las tecla R se mueve la camada de la derecha	(RIGHT)
-Con las tecla L se mueve la camada de la izquierda	(LEFT)
-Con las tecla F se mueve la camada de al frente	(FRONT)
-Con las tecla B se mueve la camada de atrás		(BACK)


EN LA LÍNEA 240 SE DEBE MODIFICAR EL PATH QUE APUNTE A 'imagen.png' que está dentro de la carpeta cubo_rubick_13
